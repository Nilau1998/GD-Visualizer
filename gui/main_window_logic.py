...
class TrainingThread(QThread):
    ...
    def run(self):
        epochs = int(self.main_window_logic.main_window_ui.epochs_lineedit.text()) - self.main_window_logic.weight_visualizer_ui.logic.model.current_epoch
...
class MainWindowLogic(QObject):
    ...
    def __init__(self, main_window_ui, weight_visualizer_ui, gd_visualizer_ui):
        super().__init__()
        self.main_window_ui = main_window_ui
        self.weight_visualizer_ui = weight_visualizer_ui
        self.gd_visualizer_ui = gd_visualizer_ui
        ...
        self.update_weights_signal.connect(self.weight_visualizer_ui.update_weights)
    ...
    def handle_model_selection(self):
        ...
        match selected_value:
            case "Logistic Regression":
                self.weight_visualizer_ui.logic.set_model(
                    LogisticRegression(
    ...
    def _training_loop(self):
        ...
        w, b, log_loss_train, log_loss_test = self.weight_visualizer_ui.logic.model.train_step()
        end_time = time.time()
        ...
        self.update_current_epoch_label(self.weight_visualizer_ui.logic.model.current_epoch)
        if self.weight_visualizer_ui.logic.model.current_epoch >= int(self.main_window_ui.epochs_lineedit.text()):
